        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4">Accurate Mapping</h3>
              <p className="text-lg text-gray-300 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4">Connect Your Systems</h3>
              <p className="text-lg text-gray-300 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4">Select Projects</h3>
              <p className="text-lg text-gray-300 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4">Sync Data</h3>
              <p className="text-lg text-gray-300 leading-relaxed">
